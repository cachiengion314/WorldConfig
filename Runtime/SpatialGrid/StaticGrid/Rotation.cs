...
namespace HoangNam.WorldConfig
{
  ...
  {
    public readonly quaternion ConvertEulerToQuaternion()
    {
      return quaternion.EulerXYZ(EulerRotation * math.PI / 180f);
    }

    public readonly float3x3 ConvertEulerToRotation()
    {
      return float3x3.EulerXYZ(EulerRotation * math.PI / 180f);
    }
